...
class App():
    def __init__(self, master):
        ...
        self.firstContainer = tk.Frame(master, bg='#6DDE81', width=400, height=50)
        self.firstContainer.pack()
        self.firstContainer.propagate(0)

        self.secondContainer = tk.Frame(master, bg='#6DDE81', width=400, height=250)
        self.secondContainer.pack()
        self.secondContainer.propagate(0)
        
        self.thirdContainer = Frame(master, bg='#6DDE81', width=640, height=80)
    ...
    def header(self):
        ...
        self.plant_question = OptionMenu(self.firstContainer, self.selected_option, *plant_list.keys(), command=self.change_images)
    ...
    def footer(self):
        ...
        self.button_browse = self.button(self.thirdContainer, "Selecionar arquivo")
    ...
    def label(self, container, text, side):
        lbl = Label(container, bg = "#6DDE81", text = text)
        lbl.pack(side = side)
        return lbl
    ...
    def fileDialog(self):
        self.file = filedialog.askopenfile(initialdir = "/home", title = "Selecione a imagem que deseja verificar", filetypes = (("imagem", "*.jpg *.png *.jpeg"), ("All Files", "*.*")))
        if(self.file):
